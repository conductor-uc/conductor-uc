...
export const ENCRYPTED_COLUMNS: readonly RewrapTarget[] = [
  /** SIP passwords; AAD `<tenant>:sip_credentials.secret_enc:<id>`. */
  { table: 'sip_credentials', idColumn: 'id', column: 'secret_enc' },
  /** Conference PINs; AAD `<tenant>:conference_rooms.pin_enc:<id>`. */
  { table: 'conference_rooms', idColumn: 'id', column: 'pin_enc' },
];
