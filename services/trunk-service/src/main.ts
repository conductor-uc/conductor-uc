...
import { registerEmergencyRouteRoutes } from './routes/emergency-route.routes.js';
...
const emergencyRouteRepo = createEmergencyRouteRepo(db);
...
registerEmergencyRouteRoutes(app, emergencyRouteRepo);
